...
const i18n = {
  es: {
    ...
    'prod-p2-desc':       'De la provincia de Cadìz, con el carácter del sur. Prensado en frío, de cosecha propia, con una acidez mínima que realza sin tapar. El acabado perfecto para cualquier pizza o tabla — y la razón por la que el primer bocado siempre sorprende.',
  ...
  en: {
    ...
    'about-body-2':       'Our roots come from Abruzzo, a land with a rhythm of life close to Andalusia: passion for good food, respect for time, and love for ingredients. That know-how shows up in every detail: dough fermentation, flour selection, and olive oils from Olvera.',
